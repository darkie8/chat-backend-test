 ...
 */
  ...
  app.get(`${baseUrl}/get/for/user`, auth.isAuthenticated, chatController.getUsersChat);

  // params: chatRoom, skip.
  app.get(`${baseUrl}/get/for/group`, auth.isAuthenticated, chatController.getGroupChat);

  
  // params: chatIdCsv.
  app.post(`${baseUrl}/mark/as/seen`, auth.isAuthenticated, chatController.markChatAsSeen);
 ...
 */
  ...
  app.get(`${baseUrl}/count/unseen`, auth.isAuthenticated, chatController.countUnSeenChat);
 ...
 */
  ...
  app.get(`${baseUrl}/find/unseen`, auth.isAuthenticated, chatController.findUnSeenChat);
 ...
 */
  // params: userId.
  app.get(`${baseUrl}/unseen/user/list`, auth.isAuthenticated, chatController.findUserListOfUnseenChat);
